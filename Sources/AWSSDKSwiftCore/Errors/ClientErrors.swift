...
public struct AWSClientError: AWSErrorType {
    ...
    public static var authFailure:AWSClientError { .init(.authFailure) }
    // Your account is currently blocked. Contact aws-verification@amazon.com if you have questions.
    public static var blocked:AWSClientError { .init(.blocked) }
    // The user has the required permissions, so the request would have succeeded, but the DryRun parameter was used.
    public static var dryRunOperation:AWSClientError { .init(.dryRunOperation) }
    // The request uses the same client token as a previous, but non-identical request. Do not reuse a client token with different requests, unless the requests are identical.
    public static var idempotentParameterMismatch:AWSClientError { .init(.idempotentParameterMismatch) }
    ...
    public static var invalidCharacter:AWSClientError { .init(.invalidCharacter) }
    ...
    public static var invalidPaginationToken:AWSClientError { .init(.invalidPaginationToken) }
    // A parameter specified in a request is not valid, is unsupported, or cannot be used. The returned message provides an explanation of the error value.
    public static var invalidParameter:AWSClientError { .init(.invalidParameter) }
    ...
    public static var pendingVerification:AWSClientError { .init(.pendingVerification) }
    ...
    public static var unauthorizedOperation:AWSClientError { .init(.unauthorizedOperation) }
    ...
    public static var unknownParameter:AWSClientError { .init(.unknownParameter) }
    // The specified attribute cannot be modified.
    public static var unsupportedInstanceAttribute:AWSClientError { .init(.unsupportedInstanceAttribute) }
    ...
    public static var unsupportedOperation:AWSClientError { .init(.unsupportedOperation) }
    // SOAP has been deprecated and is no longer supported. For more information, see SOAP Requests.
    public static var unsupportedProtocol:AWSClientError { .init(.unsupportedProtocol) }
