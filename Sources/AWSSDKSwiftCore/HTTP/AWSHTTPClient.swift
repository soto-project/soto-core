...
public protocol AWSHTTPClient {
    ...
    func execute(request: AWSHTTPRequest, timeout: TimeAmount, on eventLoop: EventLoop, context: AWSClient.Context) -> EventLoopFuture<AWSHTTPResponse>

    /// Execute an HTTP request with a streamed response
    func execute(request: AWSHTTPRequest, timeout: TimeAmount, on eventLoop: EventLoop, context: AWSClient.Context, stream: @escaping ResponseStream) -> EventLoopFuture<AWSHTTPResponse>
...
extension AWSHTTPClient {
    /// Execute an HTTP request with a streamed response
    public func execute(request: AWSHTTPRequest, timeout: TimeAmount, on eventLoop: EventLoop, context: AWSClient.Context, stream: @escaping ResponseStream) -> EventLoopFuture<AWSHTTPResponse> {
