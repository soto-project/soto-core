...
extension CredentialProviderFactory {
    ...
    public static func configFile(credentialsFilePath: String = "~/.aws/credentials", configFilePath: String = "~/.aws/config", profile: String? = nil) -> CredentialProviderFactory {
        return Self { context in
            let provider = AWSConfigFileCredentialProvider(credentialsFilePath: credentialsFilePath, configFilePath: configFilePath, profile: profile, context: context)
