...
class QueryEncoderTests: XCTestCase {
    ...
    func testArrayOfStructuresEncode() {
        ...
        struct Test : AWSShape {
            static let _members = [AWSShapeMember(label: "A", encoding:.list(member: "m") )]
            let a : [Test2]
    ...
    func testDictionaryEncode() {
        struct Test : AWSShape {
            static let _members = [AWSShapeMember(label: "A", encoding:.map(entry: "entry", key: "key", value: "value"))]
            let a : [String:Int]
    ...
    func testArrayEncodingEncode() {
        struct Test : AWSShape {
            static let _members = [AWSShapeMember(label: "a", encoding:.list(member:"item"))]
            let a : [Int]
        }
        let test = Test(a:[9,8,7,6])
    ...
    func testDictionaryEncodingEncode() {
        struct Test : AWSShape {
            static let _members = [AWSShapeMember(label: "A", encoding:.map(entry: "item", key: "k", value: "v"))]
            let a : [String:Int]
    ...
    func testDictionaryEncodingEncode2() {
        struct Test : AWSShape {
            static let _members = [AWSShapeMember(label: "A", encoding:.flatMap(key: "name", value: "entry"))]
            let a : [String:Int]
