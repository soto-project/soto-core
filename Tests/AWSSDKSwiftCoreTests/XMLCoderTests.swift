...
class XMLCoderTests: XCTestCase {
    ...
    struct Arrays : AWSShape {
       public static var _members: [AWSShapeMember] = [
           AWSShapeMember(label: "ArrayOfNatives", encoding: .list(member: "member"))
       ]
    ...
    struct Dictionaries : AWSShape {
       public static var _members: [AWSShapeMember] = [
           AWSShapeMember(label: "natives", encoding: .map(entry: "entry", key: "key", value: "value")),
           AWSShapeMember(label: "shapes", encoding: .flatMap(key: "key", value: "value"))
       ]
    ...
    func testDecodeExpandedContainers() {
        struct Shape : AWSShape {
            static let _members = [
                AWSShapeMember(label: "array", encoding:.list(member: "member")),
                AWSShapeMember(label: "dictionary", encoding:.map(entry: "entry", key: "key", value: "value"))
            ]
            let array : [Int]
    ...
    func testArrayEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _members = [AWSShapeMember(label: "array", encoding:.list(member: "member"))]
            let array : [Int]
        }
    ...
    func testDictionaryEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _members = [AWSShapeMember(label: "d", encoding:.map(entry:"item", key: "key", value: "value"))]
            let d : [String:Int]
        }
    ...
    func testFlatDictionaryEncodingDecodeEncode() {
        struct Shape : AWSShape {
            static let _members = [AWSShapeMember(label: "d", encoding:.flatMap(key: "key", value: "value"))]
            let d : [String:Int]
        }
    ...
    func testEnumShapeDictionaryEncodingDecodeEncode() {
        ...
        struct Shape : AWSShape {
            static let _members = [AWSShapeMember(label: "d", encoding:.map(entry:"item", key: "k", value: "v"))]
