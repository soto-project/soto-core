...
EXPAT_PREFIX_FILE="Sources/CSotoExpat/include/expat_prefix_symbols.h"

# build CSotoExpat
swift build --product CSotoExpat --enable-test-discovery

# get public symbols
find .build/x86_64-apple-macosx/debug/CSotoExpat.build -name "*.o" -exec nm -gUj {} \; > symbols.txt
